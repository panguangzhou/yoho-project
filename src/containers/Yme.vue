...
" @click="bool=!bool"></span>
    ...
    <div class="header">
            <a>
                ...
                <div class="right">
                    <div class="name eps">YOHO-a4e74f060</div>
                    <div class="trend-code-c">
                        ...
                        <div class="dot">&nbsp;#</div>
                        <div class="iconfont edit code-set icon-tab_icon_crm"></div>
                    </div>
                </div>
            </a>
